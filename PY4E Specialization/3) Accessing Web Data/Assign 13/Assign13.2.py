...
first place_id from the JSON. A place ID is a textual identifier that uniquely identifies
...
limit so you can test as often as you like. If you visit the URL with no parameters, you
get "No address..." response.
...
get different results from the geojson and json endpoints so make sure you are using the
same end point as this autograder is using.

Test Data / Sample Execution

You can test to see if your program is working with a location of
"South Federal University" which will have a place_id of "ChIJJ2MNmPl_bIcRt8t5x-X5ZhQ".
...
Python code below. Hint: The first seven characters of the place_id are "ChIJky9 ..."
