...
from that URL using urllib and then parse and extract the comment counts from the XML
...
for your testing and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://py4e-data.dr-chuck.net/comments_1209916.xml (Sum ends with 56)
...
numbers. The closest sample code that shows how to parse XML is geoxml.py. But since the
nesting of the elements in our data is different than the data we are parsing in that
...
syntax for details. You could also work from the top of the XML down to the comments node
