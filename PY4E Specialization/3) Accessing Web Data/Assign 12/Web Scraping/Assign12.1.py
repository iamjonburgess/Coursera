...
program similar to http://www.py4e.com/code3/urllink2.py. The program will use urllib to 
read the HTML from the data files below, and parse the data, extracting numbers and 
...
for your testing and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://py4e-data.dr-chuck.net/comments_1209914.html (Sum ends with 95)
...
for tag in tags:
    ...
    print('Attrs:', tag.attrs)
     '''
    # Add span tags to list
    list.append(tag.contents[0])

# Loop through list and convert tags to int
