...
for your testing and the other is the actual data you need to process for the assignment
    ...
    Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Amina.html
...
The web pages tweak the height between the links and hide the page after a few seconds to
 make it difficult for you to do the assignment without writing a Python program. But 
 frankly with a little effort and patience you can overcome these attempts to make it a 
 little harder to complete the assignment without writing a Python program. But that is 
